...
- _(The `tokens.css` header comment calls mobile-core "Poppins" — that's stale; mobile uses HankenGrotesk too now. The real divergence is light-vs-dark + the separate token file, not the font.)_
