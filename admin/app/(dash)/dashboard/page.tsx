    ...
    <div>
      ...
      <div className="grid grid-cols-2 gap-4 md:grid-cols-3 xl:grid-cols-4">
        <StatCard
          ...
          hint={`${data?.driversOnTrip ?? 0} on a trip`}
          icon={Wifi}
          loading={isLoading}
          accent
        />
        ...
        <StatCard
          label="GMV today"
          value={data ? naira(data.gmvToday) : undefined}
          icon={TrendingUp}
          loading={isLoading}
          accent
        />
        ...
        <StatCard
          ...
          hint={`${data?.driversOnboarded ?? 0} onboarded`}
          icon={Car}
          loading={isLoading}
        />
        <StatCard
          label="Onboarded drivers"
          value={data?.driversOnboarded}
          icon={UserCheck}
          loading={isLoading}
        />
