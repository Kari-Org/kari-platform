...
- **SUPER_ADMIN** — all 20.
- **OPS** — dashboard, fleet, riders r/manage, drivers r/manage/verify, dedicated r/onboard, trips r/override, disputes, tickets r/manage. _(No finance / admins / audit / settings.)_
...
> **v2 (not built):** move `ROLE_PERMISSIONS` into a DB table for runtime editing via the _Admins & Roles_
